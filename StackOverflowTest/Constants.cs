...
namespace StackOverflowTest
{
   public class Constants
    {
        public const String searchText = "Javascript";
        public const String tagSearchText = "C#";
        public const String initialMessage = "Navigated to the page !!!";
        public const String finalMessage = "Test Passed !!!";
